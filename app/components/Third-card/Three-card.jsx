  ...
  return (
    ...
    <div className="container mt-5">
      <div className="d-flex justify-content-between">
        ...
        <Image className="text" src={arrow} width={90} alt="logo" />
      </div>
      <div className="">
            ...
            <div class="card back-shadow">
              ...
              <div class="card-body">
                <div className="d-flex">
                  <p>{item.heading}</p>
                  <Image src={item.image} className="mx-5" width={60} />
                </div>
              ...
              <div className="mx-5 ">
                <button class="btn-cOlor text-white bUtton rounded-pill mx-5 px-2 py-2 px-4 fw-bold" type="submit">{item.buttoN}</button>
              </div>
            </div>
